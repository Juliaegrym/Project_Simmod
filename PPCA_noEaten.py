...
BP =            [None, 0.8, 0.6, 0.2]
DP =            [None, None, 0.1, 0.3]
CP =            [None, 0.5, 0.5, None]
MP =            [None, 0.6, 0.3, 0.5]   #moveprob
...
class Cell:
    def __init__(self, kind):
        ...
        self.state = 1      # States of cell, 1 = no attack this update, 2 = successful top attack this update, 3 = successful low attack this update
...
def reproduction(place, i, j, grid):
    ...
    if (place.kind == 1) and (prey >= op_threshold):
        ...
        # low level predators can reproduce with some probability
        elif max_species == 1:
        ...
        # Top level can reproduce with some probability
        elif max_species == 2:
